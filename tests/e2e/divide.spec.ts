...
const testCases = [
  ...
  {
    id: 'TC-DIV-101',
    description: 'Divisor is very small number resulting in a large number',
    dividend: 50,
    divisor: 1e-100,
    expected: 50 / 1e-100,
    skip: true,
  ...
  {
    id: 'TC-DIV-102',
    description: 'Dividend is Very small number resulting in a small number',
    dividend: 1e-100,
    divisor: 50,
    expected: 1e-100 / 50,
    skip: true,
  ...
  {
    id: 'TC-DIV-301',
    description: 'Dividend with max safe integer',
    dividend: Number.MAX_SAFE_INTEGER,
    divisor: 10,
    expected: Number.MAX_SAFE_INTEGER / 10,
  },
  {
    id: 'TC-DIV-302',
    description: 'Divisor with max safe integer',
    dividend: 10,
    divisor: Number.MAX_SAFE_INTEGER,
    expected: 10 / Number.MAX_SAFE_INTEGER,
    skip: true,
  },
  {
    id: 'TC-DIV-303',
    description: 'Dividend with min safe integer',
    dividend: Number.MIN_SAFE_INTEGER,
    divisor: 10,
    expected: Number.MIN_SAFE_INTEGER / 10,
  },
  {
    id: 'TC-DIV-304',
    description: 'Divisor with min safe integer',
    dividend: 10,
    divisor: Number.MIN_SAFE_INTEGER,
    expected: 10 / Number.MIN_SAFE_INTEGER,
    skip: true,
  },
  ...
  {
    id: 'TC-DIV-312',
    description: 'Both are float numbers but dividend is higher',
    dividend: 654.321,
    divisor: 123.456,
    expected: 654.321 / 123.456,
    skip: true,
  },
  {
    id: 'TC-DIV-313',
    description: 'Both are float numbers but divisor is higher',
    dividend: 123.456,
    divisor: 654.321,
