...
const testCases = [
  ...
  // Edge Cases
  { id: 'TC-ADD-101', description: 'First addend as a number and second addend as a string number', first_addend: 10, second_addend: '20', expected: 10 + Number('20') },
  { id: 'TC-ADD-102', description: 'First addend as a string number and second addend as a number', first_addend: '10', second_addend: 20, expected: Number('10') + 20 },
  { id: 'TC-ADD-103', description: 'Both operands as string numbers', first_addend: '10', second_addend: '20', expected: Number('10') + Number('20') },
  { id: 'TC-ADD-104', description: 'First addend as a very large and second addend as a very small', first_addend: 1e+100, second_addend: 1e-100, expected: 1e+100 + 1e-100, skip: true },
  { id: 'TC-ADD-105', description: 'First addend as a very small and second addend as a very large', first_addend: 1e-100, second_addend: 1e+100, expected: 1e-100 + 1e+100, skip: true },
  { id: 'TC-ADD-106', description: 'Both operands as very large numbers', first_addend: 1e+100, second_addend: 1e+100, expected: 1e+100 + 1e+100, skip: true },
  { id: 'TC-ADD-107', description: 'Both operands as very small numbers', first_addend: 1e-100, second_addend: 1e-100, expected: 1e-100 + 1e-100, skip: true }, 
  ...
  { id: 'TC-ADD-218', description: 'First addend as a boolean (true) and second as a boolean (false)', first_addend: true, second_addend: false, expected: invalidArgumentMessage },
  { id: 'TC-ADD-219', description: 'First addend as a boolean (false) and second as a boolean (true)', first_addend: false, second_addend: true, expected: invalidArgumentMessage },
  ...
  // Special Cases
  { id: 'TC-ADD-301', description: 'First addend as the maximum safe integer', first_addend: Number.MAX_SAFE_INTEGER, second_addend: 10, expected: Number.MAX_SAFE_INTEGER + 10 },
  { id: 'TC-ADD-302', description: 'Second addend as the maximum safe integer', first_addend: 20, second_addend: Number.MAX_SAFE_INTEGER, expected: 20 + Number.MAX_SAFE_INTEGER },
  { id: 'TC-ADD-303', description: 'Both operands as the maximum safe integer', first_addend: Number.MAX_SAFE_INTEGER, second_addend: Number.MAX_SAFE_INTEGER, expected: Number.MAX_SAFE_INTEGER + Number.MAX_SAFE_INTEGER },
  { id: 'TC-ADD-304', description: 'First addend as the minimum safe integer', first_addend: Number.MIN_SAFE_INTEGER, second_addend: 10, expected: Number.MIN_SAFE_INTEGER + 10 },
  { id: 'TC-ADD-305', description: 'Second addend as the minimum safe integer', first_addend: 20, second_addend: Number.MIN_SAFE_INTEGER, expected: 20 + Number.MIN_SAFE_INTEGER },
  { id: 'TC-ADD-306', description: 'Both operands as the minimum safe integer', first_addend: Number.MIN_SAFE_INTEGER, second_addend: Number.MIN_SAFE_INTEGER, expected: Number.MIN_SAFE_INTEGER + Number.MIN_SAFE_INTEGER },
  { id: 'TC-ADD-307', description: 'First addend as the maximum value', first_addend: Number.MAX_VALUE, second_addend: 10, expected: Number.MAX_VALUE + 10, skip: true },
  { id: 'TC-ADD-308', description: 'Second addend as the maximum value', first_addend: 20, second_addend: Number.MAX_VALUE, expected: 20 + Number.MAX_VALUE, skip: true },
  { id: 'TC-ADD-309', description: 'Both operands as the maximum value', first_addend: Number.MAX_VALUE, second_addend: Number.MAX_VALUE, expected: Number.MAX_VALUE + Number.MAX_VALUE },
  ...
  { id: 'TC-ADD-312', description: 'Both operands as float numbers', first_addend: 123.456, second_addend: 654.321, expected: 123.456 + 654.321, skip: true },
]
