...
const testCases = [
  ...
  // Edge Cases
  { id: 'TC-MUL-101', description: 'Multiplier is very large and multiplicand is very small', multiplier: 1e+100, multiplicand: 1e-100, expected: 1e+100 * 1e-100 },
  { id: 'TC-MUL-102', description: 'Multiplier is very small and multiplicand is very large', multiplier: 1e-100, multiplicand: 1e+100, expected: 1e-100 * 1e+100 },
  { id: 'TC-MUL-103', description: 'Both are very large numbers', multiplier: 1e+100, multiplicand: 1e+100, expected: 1e+100 * 1e+100, skip: true },
  ...
  { id: 'TC-MUL-105', description: 'Leading to overflow (Infinity)', multiplier: 1e+308, multiplicand: 1e+10, expected: 1e+308 * 1e+10 },
  ...
  // Special Cases
  { id: 'TC-MUL-301', description: 'Multiplier is a max safe integer', multiplier: Number.MAX_SAFE_INTEGER, multiplicand: 4, expected: Number.MAX_SAFE_INTEGER * 4 },
  { id: 'TC-MUL-302', description: 'Multiplicand is a max safe integer', multiplier: 8, multiplicand: Number.MAX_SAFE_INTEGER, expected: 8 * Number.MAX_SAFE_INTEGER, skip: true },
  { id: 'TC-MUL-303', description: 'Both are max safe integers', multiplier: Number.MAX_SAFE_INTEGER, multiplicand: Number.MAX_SAFE_INTEGER, expected: Number.MAX_SAFE_INTEGER * Number.MAX_SAFE_INTEGER, skip: true },
  { id: 'TC-MUL-304', description: 'Multiplier is a min safe integer', multiplier: Number.MIN_SAFE_INTEGER, multiplicand: 4, expected: Number.MIN_SAFE_INTEGER * 4 },
  { id: 'TC-MUL-305', description: 'Multiplicand is a min safe integer', multiplier: 8, multiplicand: Number.MIN_SAFE_INTEGER, expected: 8 * Number.MIN_SAFE_INTEGER, skip: true },
  { id: 'TC-MUL-306', description: 'Both are min safe integers', multiplier: Number.MIN_SAFE_INTEGER, multiplicand: Number.MIN_SAFE_INTEGER, expected: Number.MIN_SAFE_INTEGER * Number.MIN_SAFE_INTEGER, skip: true },
